...
class TestPrintTokens(unittest.TestCase):
    ...
    def test_printTokens_with_valid_input(self):
        tokens = [Token("hello", "word"), Token("123", "number")]
        expected_output = ["hello --> word", "123 --> number"]
        self.assertEqual(printTokens(tokens), expected_output, "Expected output does not match the actual output")
    ...
    def test_printTokens_with_mixed_input(self):
